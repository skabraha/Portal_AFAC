...
class DatasImport implements ToCollection,WithHeadingRow,WithBatchInserts,WithChunkReading
{
    // /**
    //  * @param array $row
    //  *
    ...
    public function collection(Collection $rows)
    {
        foreach($rows as $row){
            ...
            'Version13' => $row['DiasIncapacidad'],
            'UUID' => $row['TipoIncapacidad'],
            'FechaTimbrado' => $row['ImporteMonetario'],
