<x-jet-form-section submit="updatePassword">
    ...
    <x-slot name="description">
        {{ __('Asegúrese de que su cuenta tenga una contraseña con 8 digitos una mayuscula y un caracter especial') }}
    </x-slot>
    ...
    <x-slot name="actions">
        <x-jet-action-message class="mr-3" on="saved">
            <div class="flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="px-4 py-2 -mx-3">
                    <div class="mx-3">
                        <span class="font-semibold text-emerald-500 dark:text-emerald-400">Guardado</span>
                        <p class="text-sm text-gray-600 dark:text-gray-200">Se actualizo de forma correcta!</p>
                    </div>
                </div>
            </div>
        ...
        <x-jet-button
            class="ml-4 inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-xs">
            {{ __('Guardar') }}
        </x-jet-button>
    </x-slot>
</x-jet-form-section>