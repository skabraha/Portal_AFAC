                ...
                <a href="{{ route('busqueda') }}">
                    <div
                        ...
                        <div class="flex items-center mb-3">
                            ...
                            <h2 class="text-gray-900 text-lg title-font font-medium">Comprobantes de pago</h2>
                        </div>
                        <div class="flex-grow">
                ...
                <a href="{{ route('cuentas') }}">
                    <div
                        ...
                        <div class="flex items-center mb-3">
                            ...
                            <h2 class="text-gray-900 text-lg title-font font-medium">Administrador de Accesos</h2>
                        </div>
                        <div class="flex-grow">
